/**
 * Pure, framework-free ranking over an `ObservatorySnapshot` (no React, no DOM — unit-tested
...
export function defaultResults(snapshot: ObservatorySnapshot): SearchResult[] {
 ...
 */
export function search(snapshot: ObservatorySnapshot, query: string): SearchResult[] {
