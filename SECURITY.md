...
HQ is **local-first**. The CLI and web UI run on your machine, read
`.hq/` (and referenced paths inside your repository for source checks), and
...
[npm package](https://www.npmjs.com/package/hq) maintainers field, or
